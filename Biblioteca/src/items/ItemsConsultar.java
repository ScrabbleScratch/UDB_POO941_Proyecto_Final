...
public class ItemsConsultar extends javax.swing.JFrame {
    ...
    private void cargarData() {
        DefaultTableModel libroData = Consulta.categoryData(Consulta.Categoria.LIBROS);
        DefaultTableModel obraData = Consulta.categoryData(Consulta.Categoria.OBRAS);
        DefaultTableModel revistaData = Consulta.categoryData(Consulta.Categoria.REVISTAS);
        DefaultTableModel cdData = Consulta.categoryData(Consulta.Categoria.CDS);
        DefaultTableModel tesisData = Consulta.categoryData(Consulta.Categoria.TESIS);
