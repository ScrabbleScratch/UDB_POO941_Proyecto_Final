...
public class UsuarioCambioContra extends javax.swing.JFrame {
    private static UsuarioCambioContra cambioContraGUI = null;

    /**
     * Creates new form RCambioContraForm
     */
    private UsuarioCambioContra() {
        initComponents();
    }
    
    public static void mount() {
        cambioContraGUI = new UsuarioCambioContra();
    ...
    public static void cambiarContra(JTextField nombre, JTextField passwd) {
        try {
            ...
            if (rs.next()) {
                consulta = "UPDATE usuarios SET passwd = (?) WHERE nombre = (?);";
                
                ps = Conexion.establecerConexion().prepareStatement(consulta);
                ps.setString(1, passwd.getText());
    ...
    private void initComponents() {
        ...
        txtContraCC = new javax.swing.JTextField();
        ...
        jLabel33.setText("Cambiar contraseña de usuario");
        ...
        jLabel4.setLabelFor(txtContraCC);
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtContraCC, javax.swing.GroupLayout.PREFERRED_SIZE, 233, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtContraCC, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel4))
                .addContainerGap())
        );
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        cambiarContra(txtNombreCC, txtContraCC);
    ...
    private javax.swing.JTextField txtContraCC;
